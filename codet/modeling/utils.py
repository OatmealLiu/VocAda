...
# Origincal CoDet reset_cls_test func.
...
def reset_cls_test(model, cls_path, num_classes):
    ...
    # Miu: Detic and CoDet codes
    # del model.roi_heads.box_predictor[0].cls_score.zs_weight
    # model.roi_heads.box_predictor[0].cls_score.zs_weight = zs_weight
