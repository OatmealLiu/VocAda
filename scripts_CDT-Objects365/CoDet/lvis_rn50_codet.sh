...
#SBATCH --output=./slurm-output/CoDet_OV-LVIS-RN50.out
...
CFG_PATH="./configs_codet/CoDet_OVLVIS_R5021k_4x_ft4x.yaml"
MODEL_PATH="./models/CoDet_OV-LVIS/CoDet_OVLVIS_R5021k_4x_ft4x.pth"
