...
#SBATCH --output=./slurm-output/CoDet_OV-LVIS-SwinB.out
...
CFG_PATH="./configs_codet/CoDet_OVLVIS_SwinB_4x_ft4x.yaml"
MODEL_PATH="./models/CoDet_OV-LVIS/CoDet_OVLVIS_SwinB_4x_ft4x.pth"
