...
class DeticFastRCNNOutputLayers(FastRCNNOutputLayers):
    ...
    # Miu: here 5 (RN50 series)
    def inference(self, predictions, proposals, spotlight_info=None):
        """
    ...
    def forward(
            self, x, classifier_info=(None, None, None)
    ):
        """
