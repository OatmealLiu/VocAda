...
# This class is the classification module used by RN50 series
...
class CustomRes5ROIHeads(Res5ROIHeads):
    ...
    def __init__(self, **kwargs):
        ...
        # Miu: here is different from Swin-B series. It has only one  box_predictor, instead of 3-cascaded ones
