...
import os
from .registry_objects365 import register_objects365_instances
...
_PREDEFINED_SPLITS_OBJECTS365 = {
    ...
    "objects365_v2_val": ("objects365/val", "objects365/annotations/zhiyuan_objv2_val_fixed_everything.json"),
    # "objects365_v2_val_rare": ("objects365/val", "objects365/annotations/zhiyuan_objv2_val_fixname_rare.json"),
}


_SPOTDET_SPLITS_OBJECTS365 = {
    # 80,000 images, 1,240,587 annotations
    "objects365_v2_val_spotdet_gt": (
        "objects365/val",
        "objects365/annotations/zhiyuan_objv2_val_fixed_everything_spotdet_gt.json"),

    "objects365_v2_val_spotdet_v2_clip_noun": (
        "objects365/val",
        "objects365/annotations/zhiyuan_objv2_val_fixed_everything_spotdet_V2_clip_synonyms=True_topk=1_alpha=0.0_beta=0.0.json"),

    "objects365_v2_val_spotdet_v2_clip_noun_noSyno": (
        "objects365/val",
        "objects365/annotations/zhiyuan_objv2_val_fixed_everything_spotdet_V2_clip_synonyms=False_topk=1_alpha=0.0_beta=0.0.json"),

    "objects365_v2_val_spotdet_v2_clip_noun_k=2": (
        "objects365/val",
        "objects365/annotations/zhiyuan_objv2_val_fixed_everything_spotdet_V2_clip_synonyms=True_topk=2_alpha=0.0_beta=0.0.json"),

    "objects365_v2_val_spotdet_v2_clip_noun_k=3": (
        "objects365/val",
        "objects365/annotations/zhiyuan_objv2_val_fixed_everything_spotdet_V2_clip_synonyms=True_topk=3_alpha=0.0_beta=0.0.json"),

    "objects365_v2_val_spotdet_v2_clip_noun_cap": (
        "objects365/val",
        "objects365/annotations/zhiyuan_objv2_val_fixed_everything_spotdet_V2_clip_synonyms=True_topk=1_alpha=0.5_beta=0.0.json"),

    "objects365_v2_val_spotdet_v2_clip_noun_img": (
        "objects365/val",
        "objects365/annotations/zhiyuan_objv2_val_fixed_everything_spotdet_V2_clip_synonyms=True_topk=1_alpha=0.0_beta=0.5.json"),

    "objects365_v2_val_spotdet_v2_clip_noun_cap_img": (
        "objects365/val",
        "objects365/annotations/zhiyuan_objv2_val_fixed_everything_spotdet_V2_clip_synonyms=True_topk=1_alpha=0.3_beta=0.3.json"),

    "objects365_v2_val_spotdet_v2_tagging_closeset": (
        "objects365/val",
        "objects365/annotations/zhiyuan_objv2_val_fixed_everything_spotdet_V2_tagging_closeset_synonyms=True.json"),

    "objects365_v2_val_spotdet_v2_tagging_openset": (
        "objects365/val",
        "objects365/annotations/zhiyuan_objv2_val_fixed_everything_spotdet_V2_tagging_openset_synonyms=True.json"),

    "objects365_v2_val_spotdet_v2_llm_inList": (
        "objects365/val",
        "objects365/annotations/zhiyuan_objv2_val_fixed_everything_spotdet_V2_GPT35_inList.json"),

    "objects365_v2_val_spotdet_v2_llm_inCLIP": (
        "objects365/val",
        "objects365/annotations/zhiyuan_objv2_val_fixed_everything_spotdet_V2_GPT35_inCLIP.json"),
}


def register_all_objects365(root="datasets"):
    for key, (image_root, json_file) in _PREDEFINED_SPLITS_OBJECTS365.items():
        register_objects365_instances(
          key,
    ...
    for key, (image_root, json_file) in _SPOTDET_SPLITS_OBJECTS365.items():
        register_objects365_instances(
          key,
          _get_builtin_metadata(),
          os.path.join(root, json_file) if "://" not in json_file else json_file,
...
# if __name__.endswith(".builtin_objects365"):
