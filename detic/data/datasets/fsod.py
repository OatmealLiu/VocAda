...
---
Notes:
    1. Large-categories: 1000 in total
    2. Few images per categories
    3. Built from OpenImage v4 and ImageNet-21k hierarchy
    4. Train-Test splits' categories are disjoint
    5. 531 categories are from ImageNet dataset and 469 from Open Image dataset
    6. average 2.48 bboxes per image, 74.31 images per category
    7. 83 parents semantics for 1000
    8. Train set is using categories overlapped w/ COCO and ImageNet
    9. Test split is constructed by choosing categories with largest semantic distance following a is-a realtionship
       on WordNet.
    
Split:
    - Train: 800 categories w/ 82/83 super categories, w/ 52k images and 147k bboxes
    - Test : 200 categories w/ 55/83 super categories, w/ 14k images and 35k bboxes
...
_PREDEFINED_FSOD_HRCHY_CATEGORIES = {
    ...
    "fsod_test_toy200": categories_l3,

    "fsod_test_l3_spotdet_gt": categories_l3,
    "fsod_test_l3_spotdet_llm": categories_l3,
    "fsod_test_l3_spotdet_clip_noun": categories_l3,
    "fsod_test_l3_spotdet_clip_noun_cap": categories_l3,
    "fsod_test_l3_spotdet_clip_noun_img": categories_l3,
    "fsod_test_l3_spotdet_clip_noun_cap_img": categories_l3,
    "fsod_test_l3_spotdet_sbert_noun": categories_l3,
    "fsod_test_l3_spotdet_sbert_noun_cap": categories_l3,
}
