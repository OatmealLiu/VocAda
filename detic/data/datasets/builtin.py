...
from .coco8 import register_all_coco8
from .lvis_v1_val import register_all_lvis_v1_val_only
...
if __name__.endswith(".builtin"):
    ...
    # |- COCO8 Toy set
    register_all_coco8(_root)
    register_all_tools(_root)
    # |- Miu: LVIS V1 Val Only This is a TODO!
    register_all_lvis_v1_val_only(_root)
