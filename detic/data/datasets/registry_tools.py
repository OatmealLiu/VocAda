...
Register FSOD 3 layers to the DatasetCatalog
"""

__all__ = ["register_tools_instances"]


def register_tools_instances(name, metadata, json_file, image_root):
    """
