...
from codet.modeling.utils import reset_cls_test, reset_cls_test_coco

from codet.evaluation.inateval import INATEvaluator
from codet.evaluation.fsodeval import FSODEvaluator
from codet.evaluation.coco8eval import COCO8Evaluator
...
def do_test(cfg, model):
    ...
    for d, dataset_name in enumerate(cfg.DATASETS.TEST):
        ...
        output_folder = os.path.join(
            cfg.OUTPUT_DIR, "inference_{}".format(dataset_name)    # Original version
            # cfg.OUTPUT_DIR, "inference_{}_{}".format(dataset_name, cfg.MODEL.TEST_CLASSIFIERS[d])   # Miu-version: added classifier name into output name
        )
