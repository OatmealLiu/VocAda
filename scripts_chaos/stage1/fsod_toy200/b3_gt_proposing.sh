...
IMAGE_FOLDER="./datasets/fsod/images_toy"
IMAGE_ANNO_PATH="./datasets/fsod/annotations/fsod_test_toy200.json"

QS_FILE="./stage1_questions/list_all_objects.jsonl"
ANSWERS_FOLDER="./stage1_answers/fsod_toy200"
ANSWERS_FILE="answered_7b_annotations_fsod_toy200"
...
CUDA_VISIBLE_DEVICES=${GPU_IDS} python run_stage1.py \
      ...
      --dataset-name "fsod_toy200" \
      --pipeline-proposing "ground_truth" \
      --proposing-topk 3 \
